...
text_copy_file_finish = 'File {} copied'
...
text_dialog_copy = 'Would you like to copy some files? ("y" - yes, "n" - no)\n'
...
text_old_set_alarm = 'Old set contains {} files and directories'
